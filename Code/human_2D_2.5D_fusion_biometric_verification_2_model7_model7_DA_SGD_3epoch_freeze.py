...
def train_model(datax, datay, valx, valy):
    ...
    # fit model
    history = model.fit([datax[:, 0], datax[:, 1],datax[:,2], datax[:,3]], datay[:], epochs=3, batch_size=32,
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_3epoch_freeze_graph_2.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_3epoch_freeze_roc_2.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_3epoch_freeze_display_roc_2.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_3epoch_freeze_confusionMatrix_2.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_3epoch_freeze_EER_2.png')
plt.close()

pred_prob=pred_prob*100
same=[pred_class==labelTest]

np.savetxt('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_3epoch_freeze_scores_2.csv', np.array(list(zip(nameTest,pred_prob,pred_class,labelTest,same))), delimiter=',', header="Image1,Image2,pred probability,pred class, actual class, same(0)",fmt='%f')

model.save('../Models/human_2D_2.5D_fusion_verification_model7_model7_DA_3epoch_freeze_2.h5')
print("saved")