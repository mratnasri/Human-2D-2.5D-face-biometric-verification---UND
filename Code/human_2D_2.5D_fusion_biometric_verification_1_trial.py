...
def train_model(datax, datay, valx, valy):
    ...
    model.summary()
    keras.utils.plot_model(model,"../../Outputs/fusion_2D-2.5D_model_1.png",show_shapes=True)
    # fit model
    history = model.fit({"input_2D_left": datax[:, 0],"input_2D_right": datax[:, 1],"input_25D_left": datax[:,2],"input_25D_right": datax[:,3]}, datay[:], epochs=1, batch_size=32,
...
model.save('../Models/human_2D_2.5D_fusion_verification_model1_trial_2.h5')
print("saved")
