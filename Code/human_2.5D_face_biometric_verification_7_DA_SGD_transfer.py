...
def train_model(datax, datay, valx, valy,n_fixed):
    ...
    model=load_model('../Models/human_2D_verification_model7_DA_2.h5')
    ...
    model.compile(optimizer=opt, loss='binary_crossentropy',
                        metrics=['accuracy'])
    model.summary()
    keras.utils.plot_model(model,"../../Outputs/verification_2.5D_model_7_DA_transfer.png",show_shapes=True)
    # fit model
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2.5D_model7_DA_transfer_graph.png')
plt.close()
model.save('../Models/human_2.5D_verification_model7_DA_transfer.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2.5D_model7_DA_transfer_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2.5D_model7_DA_transfer_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2.5D_model7_DA_transfer_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2.5D_model7_DA_transfer_EER.png')
plt.close()