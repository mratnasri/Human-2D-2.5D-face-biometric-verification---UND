...
def model_config(input_shape):
    ...
    model_2D=load_model('../Models/human_2D_verification_model2_DA.h5')
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_model2_DA_transfer.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_model2_DA_transfer_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_model2_DA_transfer_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_model2_DA_transfer_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_model2_DA_transfer_EER.png')
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model2_model2_DA_transfer.h5')
print("saved")