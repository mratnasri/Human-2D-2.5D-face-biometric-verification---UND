...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_model2_DA_stratify_graph_testing.png')
plt.close()
#model.save('../Models/human_2D_verification_model2_DA_stratify_3.h5')
#print("saved")"""
...
plt.savefig('../../Outputs/verification_model2_DA_stratify_roc_testing.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_model2_DA_stratify_display_roc_testing.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_model2_DA_stratify_confusionMatrix_testing.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_model2_DA_stratify_EER_testing.png')
plt.close()