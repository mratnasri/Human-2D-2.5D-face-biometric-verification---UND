...
def train_model(datax, datay, valx, valy):
    ...
    # fit model
    history = model.fit([datax[:, 0], datax[:, 1]], datay[:], epochs=3, batch_size=32,
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2.5D_model9_DA_3epoch_graph.png')
plt.close()
model.save('../Models/human_2.5D_verification_model9_DA_3epoch.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2.5D_model9_DA_3epoch_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2.5D_model9_DA_3epoch_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2.5D_model9_DA_3epoch_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2.5D_model9_DA_3epoch_EER.png')
plt.close()
...
np.savetxt('../../Outputs/verification_2.5D_model9_DA_3epoch_scores.csv', A, fmt='%s', delimiter=',', header="Image1,Image2,pred probability,pred class, actual class, same(0)")