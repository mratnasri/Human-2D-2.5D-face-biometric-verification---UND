...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_model2_DA_stratify_graph_3.png')
plt.close()
...
plt.savefig('../../Outputs/verification_model2_DA_stratify_roc_3.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_model2_DA_stratify_display_roc_3.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_model2_DA_stratify_confusionMatrix_3.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_model2_DA_stratify_EER_3.png')
plt.close()