...
def train_model(datax, datay, valx, valy):
    ...
    model.summary()
    keras.utils.plot_model(model,"../../Outputs/fusion_2D-2.5D_model_2.png",show_shapes=True)
    # fit model
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_display_roc.png')
plt.close()
fnr = 1 - tpr
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_EER.png')
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model2.h5')
print("saved")