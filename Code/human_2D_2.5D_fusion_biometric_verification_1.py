...
def model_config(input_shape):
    ...
    fusion_net = Model(inputs=[input_2D_left,input_2D_right, input_25D_left,input_25D_right], outputs=prediction, name='fusion_model_2D_2_5D')
...
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model1_2.h5')
print("saved")