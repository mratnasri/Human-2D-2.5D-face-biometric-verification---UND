...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2.5D_model2_DA_stratify_graph.png')
plt.close()
model.save('../Models/human_2.5D_verification_model2_DA_stratify.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2.5D_model2_DA_stratify_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2.5D_model2_DA_stratify_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2.5D_model2_DA_stratify_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2.5D_model2_DA_stratify_EER.png')
plt.close()