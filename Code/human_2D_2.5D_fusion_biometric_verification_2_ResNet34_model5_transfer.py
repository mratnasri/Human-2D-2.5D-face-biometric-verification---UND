...
x_train_2D, x_test_2D, y_train_2D, y_test_2D = train_test_split(
    images_2D, targets_2D, test_size=0.3, shuffle=True, random_state=mystate)
...
x_train_25D, x_test_25D, y_train_25D, y_test_25D = train_test_split(
    images_25D, targets_25D, test_size=0.3, shuffle=True, random_state=mystate)
...
x_train_2D.extend(noise_images_2D)
y_train_2D.extend(noise_targets_2D)
x_train_25D.extend(noise_images_25D)
...
def train_model(datax, datay, valx, valy):
    model_2D=load_model('../Models/human_2D_verification_model5_ResNet34_DA.h5')
    model_2D._name="model_2D"
    model_2D.optimizer._name=model_2D.optimizer._name+str("_2D")
    model_25D=load_model('../Models/human_2.5D_verification_model5_ResNet34_DA_transfer.h5')
    ...
    model.compile(optimizer=opt, loss='binary_crossentropy',
                        metrics=['accuracy'])
    model.summary()
    #keras.utils.plot_model(model,"../../Outputs/fusion_2D-2.5D_model_2_ResNet34_model5.png",show_shapes=True)
    # fit model
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_transfer.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_transfer_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_transfer_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_transfer_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_transfer_EER.png')
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model2_ResNet34_model5_transfer.h5')
print("saved")