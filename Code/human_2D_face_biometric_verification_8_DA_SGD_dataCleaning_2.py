...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_model8_DA_graph_2.png')
plt.close()
model.save('../Models/human_2D_verification_model8_DA_2.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2D_model8_DA_roc_2.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_model8_DA_display_roc_2.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_model8_DA_confusionMatrix_2.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_model8_DA_EER_2.png')
plt.close()
...
np.savetxt('../../Outputs/verification_2D_model8_DA_scores_2.csv', zip(nameTest,pred_prob,pred_class,labelTest,same), delimiter=',', header="Image1,Image2,pred probability,pred class, actual class, same(0)",fmt='%f')