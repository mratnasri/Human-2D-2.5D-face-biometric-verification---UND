...
def model_config(input_shape):
    ...
    model_25D=load_model('../Models/human_2.5D_verification_model5_ResNet34_DA.h5')
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_display_roc.png')
plt.close()
fnr = 1 - tpr
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model2_ResNet34_model5_EER.png')
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model2_ResNet34_model5.h5')
print("saved")