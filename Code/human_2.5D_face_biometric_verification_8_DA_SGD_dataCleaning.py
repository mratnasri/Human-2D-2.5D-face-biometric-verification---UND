...
def model_config(input_shape):
    ...
    L1_layer = Lambda(lambda tensors: tensorflow.keras.backend.abs(
        tensors[0] - tensors[1]))
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2.5D_model8_DA_graph.png')
plt.close()
model.save('../Models/human_2.5D_verification_model8_DA.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2.5D_model8_DA_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2.5D_model8_DA_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2.5D_model8_DA_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2.5D_model8_DA_EER.png')
plt.close()
...
np.savetxt('../../Outputs/verification_2.5D_model8_DA_scores.csv', zip(nameTest,pred_prob,pred_class,labelTest,same), delimiter=',', header="Image1,Image2,pred probability,pred class, actual class, same(0)",fmt='%f')