...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_model9_DA_graph_7.png')
plt.close()
model.save('../Models/human_2D_verification_model9_DA_7.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2D_model9_DA_roc_7.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_model9_DA_display_roc_7.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_model9_DA_confusionMatrix_7.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_model9_DA_EER_7.png')
plt.close()
...
np.savetxt('../../Outputs/verification_2D_model9_DA_scores_7.csv', list(zip(nameTest,pred_prob,pred_class,labelTest,same)), delimiter=',', header="Image1,Image2,pred probability,pred class, actual class, same(0)")