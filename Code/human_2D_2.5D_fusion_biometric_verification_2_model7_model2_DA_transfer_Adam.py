...
def train_model(datax, datay, valx, valy):
    ...
    opt = Adam(lr=0.001,name="Adam_fusion")
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model2_DA_transfer_Adam_graph.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model2_DA_transfe_Adamr_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model2_DA_transfer_Adam_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model2_DA_transfer_Adam_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model2_DA_transfer_Adam_EER.png')
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model7_model2_DA_transfer_Adam.h5')
print("saved")