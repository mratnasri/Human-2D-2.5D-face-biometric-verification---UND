...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_model1_graph_3.png')
plt.close()
model.save('../Models/human_2D_verification_model1_3.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_model1_roc_3.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_model1_display_roc_3.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_model1_confusionMatrix_3.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_model1_EER_3.png')
plt.close()