...
all_images_cropped = '../../UND 2D face data/original data/*.ppm'
dataAugmentation_crop = '../../UND 2D face data/original data_DA/*_cropped.ppm'
dataAugmentation_rotate = '../../UND 2D face data/original data_DA/*_rotated*.ppm'
noise_augmentation = '../../UND 2D face data/original data_DA/*_noise.ppm'
#categories_n = 200
...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_model6_DA_graph.png')
plt.close()
model.save('../Models/human_2D_verification_model6_DA.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2D_model6_DA_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_model6_DA_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_model6_DA_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_model6_DA_EER.png')
plt.close()