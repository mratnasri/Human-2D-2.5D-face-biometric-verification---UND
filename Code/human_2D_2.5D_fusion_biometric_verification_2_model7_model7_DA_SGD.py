...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_graph.png')
plt.close()
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2D_2.5D_fusion_model7_model7_DA_SGD_EER.png')
plt.close()
model.save('../Models/human_2D_2.5D_fusion_verification_model7_model7_DA_transfer.h5')
print("saved")