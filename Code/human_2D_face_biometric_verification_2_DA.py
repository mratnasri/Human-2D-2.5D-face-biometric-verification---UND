...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_model2_DA_graph.png')
plt.close()
model.save('../Models/human_2D_verification_model2_DA.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_model2_DA_roc.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_model2_DA_display_roc.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_model2_DA_confusionMatrix.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_model2_DA_EER.png')
plt.close()