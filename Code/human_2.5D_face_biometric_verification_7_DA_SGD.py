...
plt.xlabel('epoch')
# plt.show()
plt.savefig('../../Outputs/verification_2.5D_model7_DA_graph_2.png')
plt.close()
model.save('../Models/human_2.5D_verification_model7_DA_2.h5')
print("saved")
...
plt.savefig('../../Outputs/verification_2.5D_model7_DA_roc_2.png')
plt.close()
roc_display = RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=auc)
roc_display.plot()
plt.savefig('../../Outputs/verification_2.5D_model7_DA_display_roc_2.png')
plt.close()
fnr = 1 - tpr
...
plt.savefig('../../Outputs/verification_2.5D_model7_DA_confusionMatrix_2.png')
plt.close()
...
legend = ax.legend()
plt.savefig('../../Outputs/verification_2.5D_model7_DA_EER_2.png')
plt.close()